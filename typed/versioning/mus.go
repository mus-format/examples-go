...
func (s fooMUS) Marshal(foo Foo, bs []byte) (n int) {
	return FooV2TypedMUS.Marshal(FooV2(foo), bs)
}
...
func (s fooMUS) Unmarshal(bs []byte) (foo Foo, n int, err error) {
	...
	case FooV1DTM:
		var fooV1 FooV1
		fooV1, n, err = FooV1TypedMUS.UnmarshalData(bs[n:])
		if err != nil {
			return
		}
	...
	case FooV2DTM:
		var fooV2 FooV2
		fooV2, n, err = FooV2TypedMUS.UnmarshalData(bs[n:])
		foo = Foo(fooV2)
	default:
...
func (s fooMUS) Size(foo Foo) (size int) {
	return FooV2TypedMUS.Size(FooV2(foo))
}
...
func (s fooMUS) Skip(bs []byte) (n int, err error) {
	...
	switch dtm {
	case FooV1DTM:
		return FooV1TypedMUS.Skip(bs[n:])
	case FooV2DTM:
		return FooV2TypedMUS.Skip(bs[n:])
	default:
		panic(fmt.Sprintf("unexpected %v DTM", dtm))
	}
}
